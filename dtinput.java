...
public class dtinput {
    ...
    //Array
    private String[][] dtProduk = new String[jRecord][4];
    Scanner dtIN = new Scanner(System.in);
    
    //constactor
    public dtinput(int nval){
        this.jRecord = nval;
    }
    ...
    public void UpdateData(){
        ...
        System.out.println("~~~~~~~~~");
        System.out.println("Nama Produk: "+dtProduk[idx][0]);
        System.out.print("Diubah menjadi: ");
        dtProduk[idx][0] = dtIN.nextLine();
        
        System.out.println("Deskripsi Produk: "+dtProduk[idx][1]);
        System.out.print("Diubah menjadi: ");
        dtProduk[idx][1] = dtIN.nextLine();
        
        System.out.println("Jumlah Produk: "+dtProduk[idx][2]);
        System.out.print("Diubah menjadi: ");
        dtProduk[idx][2] = dtIN.nextLine();
        
        System.out.println("Tanggal Input: "+dtProduk[idx][3]);
        System.out.print("Diubah menjadi: ");
        dtProduk[idx][2] = dtIN.nextLine();
    ...
    public void viewData(){
        ...
        for (int i=0; i<aRec; i++){
            ...
            System.out.println("Nama Produk :"+dtProduk[i][0]);
            System.out.println("Deskripsi Produk :"+dtProduk[i][1]);
            System.out.println("Jumlah Produk :"+dtProduk[i][2]);
            System.out.println("Tanggal Input :"+dtProduk[i][3]);
        }
        System.out.println("");
